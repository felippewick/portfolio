...
inside Markdown files. The blog you're reading right now [uses this](https://github.com/felippewick/felippewick.io).
...
Feel free to [reach out](mailto:me@felippewick.io) if you wanna chat about building design systems.
