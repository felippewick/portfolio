...
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
  <url>
      <loc>https://felippewick.io</loc>
  </url>
  <url>
      <loc>https://felippewick.io/blog</loc>
  </url>
</urlset>
```
...
> **Note:** `globby` [might not work](https://github.com/felippewick/felippewick.io/issues/293) on Windows.
    ...
    <urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
        ${pages
          .map((page) => {
            ...
            return `
              <url>
                  <loc>${`https://felippewick.io${route}`}</loc>
              </url>
            `;
          })
          .join('')}
...
```bash
User-agent: *
Sitemap: https://felippewick.io/sitemap.xml
```
