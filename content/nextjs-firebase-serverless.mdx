...
export default async function Page() {
  const user = await db.collection('users').doc('felippewick').get();
...
- [View the code](https://github.com/felippewick/nextjs-vercel-firebase)
- [View the demo](https://nextjs-vercel-firebase.vercel.app/)
- [Deploy to Vercel](https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2Ffelippewick%2Fnextjs-vercel-firebase&env=NEXT_PUBLIC_FIREBASE_PROJECT_ID,FIREBASE_CLIENT_EMAIL,FIREBASE_PRIVATE_KEY&project-name=nextjs-firebase&repo-name=nextjs-firebase)
